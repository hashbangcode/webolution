...
class ElementPopulationDecoratorTestBase extends \PHPUnit_Framework_TestCase
{
    ...
    public function setup()
    {
        ...
        $text1 = $this->prophet->prophesize('Hashbangcode\Wevolution\Type\Element\Element');
        ...
        $text2 = $this->prophet->prophesize('Hashbangcode\Wevolution\Type\Element\Element');
        ...
        $text3 = $this->prophet->prophesize('Hashbangcode\Wevolution\Type\Element\Element');
        ...
        $textPopulation = $this->prophet->prophesize('Hashbangcode\Wevolution\Evolution\Population\ElementPopulation');

        $textIndividual1 = $this->prophet
            ->prophesize('Hashbangcode\Wevolution\Evolution\Individual\ElementIndividual');
