...
use Hashbangcode\Wevolution\Evolution\Population\Decorators\UnitPopulationDecoratorCli;
...
class UnitPopulationDecoratorTestBase extends \PHPUnit_Framework_TestCase
{
    ...
    public function setup()
    {
        ...
        $text1 = $this->prophet->prophesize('Hashbangcode\Wevolution\Type\Unit\Unit');
        $text1->getUnit()->willReturn('abc');

        $text2 = $this->prophet->prophesize('Hashbangcode\Wevolution\Type\Unit\Unit');
        $text2->getUnit()->willReturn('def');

        $text3 = $this->prophet->prophesize('Hashbangcode\Wevolution\Type\Unit\Unit');
        $text3->getUnit()->willReturn('ghi');

        $textPopulation = $this->prophet->prophesize('Hashbangcode\Wevolution\Evolution\Population\UnitPopulation');

        $textIndividual1 = $this->prophet
            ->prophesize('Hashbangcode\Wevolution\Evolution\Individual\UnitIndividual');
